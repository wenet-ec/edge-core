# edge_agent/test/edge_agent_web/plugs/assign_request_id_test.exs
defmodule EdgeAgentWeb.Plugs.AssignRequestIdTest do
  use ExUnit.Case, async: true

  import Plug.Test

  alias EdgeAgentWeb.Plugs.AssignRequestId
  ...
  describe "sets x-request-id response header" do
    ...
    test "overwrites any existing x-request-id header (agent is request origin, not relay)" do
      conn =
        :get
        |> conn("/")
