...
| Netmaker    | `gravitl/netmaker`            | `v1.7.0`       | Admin and agent are built against this Netmaker API version |
| Netmaker UI | `gravitl/netmaker-ui`         | `v1.7.0`       | Must match Netmaker server version                          |
...
- Source: <https://github.com/gravitl/netmaker/tree/v1.7.0>
