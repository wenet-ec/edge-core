# lib/edge_admin_web/controllers/metrics/agent_metrics_discovery_controller.ex
defmodule EdgeAdminWeb.Controllers.Metrics.AgentMetricsDiscoveryController do
  ...
  @doc """
  Service discovery endpoint for vmagent HTTP SD (agent metrics).
