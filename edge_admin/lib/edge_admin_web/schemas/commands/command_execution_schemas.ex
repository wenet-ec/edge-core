...
defmodule EdgeAdminWeb.Schemas.Commands.CommandExecutionSchemas do
  ...
  defmodule CommandExecutionUpdateRequest do
    @moduledoc false
    require OpenApiSpex

    OpenApiSpex.schema(%{
      title: "Command Execution Update Request",
      description: "Update command execution results (typically from agents)",
      type: :object,
      properties: %{
        command_execution: %Schema{
          ...
          properties: %{
            status: %Schema{
              type: :string,
              enum: ["completed"],
              description: "Execution status (agents typically only set to 'completed')"
            },
            output: %Schema{
              type: :string,
              description: "Combined output from command execution",
