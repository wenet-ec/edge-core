...
defmodule EdgeAdminWeb.Controllers.Metrics.WireguardMetricsDiscoveryController do
  ...
  operation(:index,
    ...
    description:
      "Service discovery endpoint for Prometheus HTTP SD (WireGuard metrics). Returns all active nodes grouped by cluster in the format expected by http_sd_configs.",
    responses: %{
