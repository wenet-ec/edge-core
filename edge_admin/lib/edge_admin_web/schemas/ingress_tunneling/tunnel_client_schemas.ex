...
defmodule EdgeAdminWeb.Schemas.IngressTunneling.TunnelClientSchemas do
  ...
  defmodule EmbeddedTunnelConnectionData do
    @moduledoc false

    schema(%{
      title: "EmbeddedTunnelConnectionData",
      description: "Embedded Tunnel Connection representation within a Tunnel Client",
      type: :object,
      properties: %{
    ...
    schema(%{
      ...
      properties: %{
        ...
        tunnel_connections: %Schema{
          type: :array,
          description: "Connections embedded in this Tunnel Client",
          items: EmbeddedTunnelConnectionData
        },
