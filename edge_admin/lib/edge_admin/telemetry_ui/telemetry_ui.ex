...
defmodule EdgeAdmin.TelemetryUI do
  ...
  defp ecto_metrics do
    ...
    [
      average("edge_admin.repo.query.total_time",
        description: "Database query total time",
        keep: ecto_keep,
        unit: {:native, :millisecond},
        ui_options: [class: "col-span-3", unit: " ms"]
      ),
      average_over_time("edge_admin.repo.query.total_time",
  ...
  defp share_key, do: Application.get_env(:edge_admin, __MODULE__)[:share_key]
end
