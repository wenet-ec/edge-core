# edge_admin/lib/edge_admin_proxy/http/handler.ex
defmodule EdgeAdminProxy.Http.Handler do
  @moduledoc """
  ...
  alias EdgeAdminProxy.Http.Parser, as: HttpParser
  alias EdgeAdminProxy.Http.Request, as: HttpRequest
  alias EdgeAdminProxy.Transport.TunnelRegistry
  alias EdgeAdminProxy.Tunnel.TcpTunnel
