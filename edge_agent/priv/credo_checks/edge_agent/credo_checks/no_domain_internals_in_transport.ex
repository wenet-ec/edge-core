# edge_agent/priv/credo_checks/edge_agent/credo_checks/no_domain_internals_in_transport.ex
defmodule EdgeAgent.CredoChecks.NoDomainInternalsInTransport do
  @moduledoc false
  ...
  defp domain_internal?([:EdgeAgent, _domain, segment | _rest]) when segment in @internal_segments, do: true
