...
EVENT_BROKER_REDIS_URLS=host:6379                       # standalone: exactly one; sentinel: Sentinel endpoints; cluster: seed endpoints
EVENT_BROKER_REDIS_USERNAME=                             # optional ACL username, all modes
EVENT_BROKER_REDIS_PASSWORD=                             # optional ACL password, all modes
...
EVENT_BROKER_REDIS_URLS=sentinel-a:26379,sentinel-b:26379
EVENT_BROKER_REDIS_SENTINEL_GROUP=mymaster
EVENT_BROKER_REDIS_SENTINEL_PASSWORD=                    # optional Sentinel password

# Redis Cluster publisher (consumers still use standard SUBSCRIBE / PSUBSCRIBE):
EVENT_BROKER_REDIS_MODE=cluster
EVENT_BROKER_REDIS_URLS=redis-a:6379,redis-b:6379,redis-c:6379
```
