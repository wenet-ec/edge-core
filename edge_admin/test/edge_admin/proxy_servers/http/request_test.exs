# edge_admin/test/edge_admin/proxy_servers/http/request_test.exs
defmodule EdgeAdmin.ProxyServers.Http.RequestTest do
  use ExUnit.Case, async: true

  alias EdgeAdmin.ProxyServers.Http.Request
