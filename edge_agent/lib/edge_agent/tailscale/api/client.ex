# edge_agent/lib/edge_agent/tailscale/api/client.ex
defmodule EdgeAgent.Tailscale.Api.Client do
  @moduledoc """
  ...
  @behaviour EdgeAgent.Tailscale.Api.Behaviour
  ...
  defp wrapper_url do
    Application.get_env(:edge_agent, :vpn_wrapper_url)
  end
